...
- Scope is the local checkout; a duplicate filed on a sibling branch is invisible until merge (§7(a)/(f): detected, not prevented). No post-merge similarity check (it would have to live in validate).
