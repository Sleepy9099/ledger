...
- [x] Human answers representation / timing / warning-tier; unblock only when the measurement gate is met
- [x] Phase 1: Task.resources, next gate + resources_held, claim/unblock resource-held refusal with --force, resource-contention validate code, list --resource
- [x] DESIGN §2 tags row, §5 eligibility, §7(h); README; tests incl. the concurrency race
...
- 2026-09-02T02:59:08Z [claude-2026-09-01-b] claim: claimed
